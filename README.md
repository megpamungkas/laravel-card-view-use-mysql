...
create file for page view
create on shop\resources\views\shop\shoping-cart.blade.php
```
@extends('layouts.master')
				...
				<ul class="list-group">
					@foreach($products as $product)
						<li class="list-group-item">
							...
							<a href="" class="btn pull-right"><i class="fa-solid fa-trash"></i>  delete</a>
						</li>
					@endforeach
				</ul>
			</div>
